...
%   \end{scope}
    ...
    \draw[color=gray!30, fill=gray!30] (\xmin, \ymin) rectangle (\xmax, \ymax);
    \draw[rotate=\alpha, fill=white] (center) ellipse ({\a} and {\b});
    \draw[pattern=north west lines, pattern color=blue] (\xmin, \ymin) rectangle (13/4, \ymax);
